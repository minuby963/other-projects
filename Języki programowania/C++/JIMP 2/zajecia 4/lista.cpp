...
{
public:
    //friend istream & operator>>(istream & in,lista & l1);
    //friend ostream & operator<<(ostream & out,lista & l1);
    //friend class lista;
    wz w1;
    el<wz> *next;
...
int main()
{
    ...
    lista<int> b;
    lista<int> c;
    cout<<"podaj 1 el 1 li"<<endl;
    cin>>a;
    cout<<"podaj 2 el 1 li"<<endl;
    cin>>a;
    cout<<"podaj 3 el 1 li"<<endl;
    cin>>a;

    cout<<"podaj 1 el 2 li"<<endl;
    cin>>b;
    cout<<"podaj 2 el 2 li"<<endl;
    cin>>b;
