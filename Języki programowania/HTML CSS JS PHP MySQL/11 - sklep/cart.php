...
class cart{
	...
	public function getProducts(){
		...
		$stmt = $pdo->prepare("SELECT s.id, p.net_price, s.quantity, p.product_index, p.name, p.id as pid FROM sessioncart s LEFT OUTER JOIN products p ON (s.product_id = p.id) WHERE s.session_id  = :sid");
